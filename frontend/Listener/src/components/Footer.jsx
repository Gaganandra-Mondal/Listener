...
const Footer = () => {
  return (
    <footer className="bg-[#111111] border-t border-white/5 rounded-t-xl shadow-inner px-3 py-3 md:px-4 flex flex-col md:flex-row items-center justify-between gap-3 sticky bottom-0">
      {/* Track Info */}
