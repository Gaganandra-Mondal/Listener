...
const Footer = () => {
  return (
    <footer className="bg-[#252525] border-t border-white/5 rounded-t-xl shadow-inner px-3 py-3 md:px-4 flex flex-col md:flex-row items-center justify-between gap-3 sticky bottom-0">
      ...
      <div className="flex items-center gap-2 md:gap-3 min-w-0 flex-1 md:flex-none">
        ...
        <div className="min-w-0">
          <h4 className="text-white font-semibold text-sm truncate">Midnight Symphony</h4>
          <p className="text-gray-400 text-xs truncate">Orchestral Beats</p>
        </div>
      </div>

      {/* Player Controls */}
      <div className="flex flex-col items-center flex-1 w-full md:w-auto order-3 md:order-2">
        <div className="flex items-center gap-2 md:gap-4 mb-1 md:mb-2">
          <button className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-red-600 transition text-sm md:text-base">
            ⏮
          </button>
