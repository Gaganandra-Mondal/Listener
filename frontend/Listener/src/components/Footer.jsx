    ...
    >
      ...
      >
        <div className="flex items-center gap-4 md:gap-5 mb-4 md:mb-2">
          ...
          <button
            onClick={playHandler}
            className={`w-10 h-10 md:w-12 md:h-12 rounded-full bg-red-600 flex items-center justify-center cursor-pointer text-white hover:bg-red-500 shadow-md transition text-lg md:text-xl`}
          >
